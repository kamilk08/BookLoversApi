...
{
    public class CreateLibrarianTestAndUserIsNotAuthorizedToDoIt : EndToEndTest
    {
        ...
        [Test]
        public async Task
            CreateLibrarian_WhenCalledAndUserIsNotAuthorizedToDoIt_ShouldReturnResponseWithUnAuthorizedStatusCode()
        {
