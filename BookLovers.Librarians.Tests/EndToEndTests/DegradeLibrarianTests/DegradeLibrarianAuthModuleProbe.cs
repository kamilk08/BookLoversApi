...
{
    public class DegradeLibrarianAuthModuleProbe : IProbe
    {
        ...
        public DegradeLibrarianAuthModuleProbe(IModule<AuthModule> authModule, Guid readerGuid)
        {
        ...
        public async Task SampleAsync()
        {
            ...
            var inboxQueryResult = await _authModule.ExecuteQueryAsync<GetAuthInboxMessagesQuery, List<InBoxMessage>>(
