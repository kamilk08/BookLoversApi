...
{
    public class DegradeLibrarianAndUserIsNotAuthorizedToDoIt : EndToEndTest
    {
        ...
        [Test]
        public async Task
            DegradeLibrarian_WhenCalledAndUserIsNotAuthorizedToDoIt_ShouldReturnUnAuthorizedWithConflictStatusCode()
        {
