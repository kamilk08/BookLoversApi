...
{
    public class ChangePasswordAndUserIsTryingToChangePasswordToNotHisAccount : EndToEndTest
    {
        ...
        [Test]
        public async Task
            ChangePassword_WhenCalledAndUserIsTryingToChangePasswordToNotHisAccount_ShouldReturnForbiddenResponse()
        {
