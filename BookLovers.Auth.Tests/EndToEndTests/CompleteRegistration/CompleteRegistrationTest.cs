...
{
    public class CompleteRegistrationTest : EndToEndTest
    {
        private Guid _userGuid;
        private string _registrationToken;

        [Test]
        public async Task CompleteRegistration_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await this.E2ETester
                ...
                .SendAsyncAndMapToResult(new GetRegistrationSummaryHttpRequest(E2EConstants.DefaultUserEmail))
