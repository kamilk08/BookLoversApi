...
namespace BookLovers.Auth.Tests.EndToEndTests.LoginUser
{
    public class LoginByRefreshTokenTest : EndToEndTest
    {
        ...
        [Test]
        public async Task LoginWithRefreshToken_WhenCalled_ShouldReturnHttpResponseWithOkStatusCodeAndWithJsonWebToken()
        {
            await this.E2ETester.SendAsyncAndMapToResult(() => new LoginWithRefreshTokenRequest()
                    .WithClientId(E2EConstants.AudienceGuid)
                    .WithRefreshToken(_token.RefreshToken)
