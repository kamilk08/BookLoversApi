...
{
    public class LoginUserTest : EndToEndTest
    {
        ...
        [Test]
        public async Task LoginUser_WhenCalled_UserShouldBeLoggedInIntoSystem()
        {
            await this.E2ETester.SendAsyncAndMapToResult(LoginAsUser)
