...
{
    internal class BookByIdHandler : IQueryHandler<BookByIdQuery, BookDto>
    {
        private readonly PublicationsContext _context;
        private readonly IMapper _mapper;

        public BookByIdHandler(PublicationsContext context, IMapper mapper)
        {
            this._context = context;
            this._mapper = mapper;
        }

        public async Task<BookDto> HandleAsync(BookByIdQuery query)
        {
            ...
            var cycleQuery = _context.PublisherCycles.AsNoTracking()
                ...
                .Include(p => p.Publisher)
                .ActiveRecords()
                .Where(p => p.CycleBooks.Any(b => b.Id == query.BookId))
                .Future();
