...
{
    internal class PaginatedAuthorQuotesQueryValidator : AbstractValidator<PaginatedAuthorQuotesQuery>
    {
        public PaginatedAuthorQuotesQueryValidator()
        {
            this.RuleFor(p => p.Count)
                .GreaterThanOrEqualTo(0).WithMessage("Items per page must be greater or equal 0");
            ...
            this.RuleFor(p => p.Order)
                ...
                .LessThanOrEqualTo(QuotesOrder.ByLikes.Value).WithMessage("Invalid sort type.");
        }
    }
}