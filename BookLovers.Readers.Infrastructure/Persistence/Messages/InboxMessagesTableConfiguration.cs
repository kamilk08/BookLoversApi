...
namespace BookLovers.Readers.Infrastructure.Persistence.Messages
{
    public class InboxMessagesTableConfiguration : EntityTypeConfiguration<InBoxMessage>
    {
        public InboxMessagesTableConfiguration()
        {
            ...
            this.Property(p => p.Guid).HasColumnOrder(1)
