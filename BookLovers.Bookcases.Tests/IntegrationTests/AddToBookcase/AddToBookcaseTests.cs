...
{
    [TestFixture]
    public class AddToBookcaseTests : IntegrationTest<BookcaseModule, AddToBookcaseCommand>
    {
        ...
        public async Task AddToBookcase_WhenCalled_ShouldAddBookToBookcase()
        {
            ...
            bookcaseDto.Value.BooksCount.Should().Be(1);
        }

        [Test]
        public async Task AddToBookcase_WhenCalledAndCommandIsNull_ShouldReturnValidationResultWithErrors()
        {
            Command = null;
        ...
        [Test]
        public async Task AddToBookcase_WhenCalledAndCommandHasInvalidData_ShouldReturnValidationResultWithErrors()
        {
