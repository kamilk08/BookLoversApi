...
{
    public class AddShelfToBookcaseThatUsedDoNotOwnTest : EndToEndTest
    {
        ...
        [Test]
        public async Task
            AddShelf_WhenCalledAndUserIsNotAnOwnerOfTheBookcase_ShouldReturnRespondWithUnAuthorizedStatusCode()
        {
            await E2ETester
