...
{
    public class ChangeShelfNameAndShelfIsMissing : EndToEndTest
    {
        ...
        [Test]
        public async Task ChangeShelfName_WhenCalledAndShelfIsMissing_ShouldReturnResponseWithConflictStatusCode()
        {
            await E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() =>
                    new ChangeShelfNameRequest(_bookcaseGuid, Fixture.Create<Guid>(), _newShelfName, _token))
