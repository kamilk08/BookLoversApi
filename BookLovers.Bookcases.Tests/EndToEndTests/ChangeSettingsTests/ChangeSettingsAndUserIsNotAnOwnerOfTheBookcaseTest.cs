...
namespace BookLovers.Bookcases.Tests.EndToEndTests.ChangeSettingsTests
{
    public class ChangeSettingsAndUserIsNotAnOwnerOfTheBookcaseTest : EndToEndTest
    {
        ...
        [Test]
        public async Task ChangeSettings_WhenCalledAndUserIsNotAnOwnerOfTheBookcase_ShouldReturnUnauthorizedStatusCode()
        {
            await E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(ChangeSettings)
        ...
        private ChangeBookcaseSettingsHttpRequest ChangeSettings()
        {
            return new ChangeBookcaseSettingsHttpRequest(_bookcaseGuid, _token).AddPrivacyOption(
