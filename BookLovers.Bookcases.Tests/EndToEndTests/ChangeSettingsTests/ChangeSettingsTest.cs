...
{
    public class ChangeSettingsTest : EndToEndTest
    {
        ...
        [Test]
        public async Task ChangeSettings_WhenCalled_ShouldReturnResponseWithStatusCodeOk()
        {
            await E2ETester
        ...
        private ChangeBookcaseSettingsHttpRequest ChangeSettings()
        {
            return new ChangeBookcaseSettingsHttpRequest(_bookcaseGuid, _token)
                .AddPrivacyOption(BookcaseOptionType.Privacy, PrivacyOption.Public);
        }
    }
}