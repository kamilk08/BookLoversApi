...
{
    public class ChangeSettingsAndUserTriesToSetInvalidOption : EndToEndTest
    {
        ...
        [Test]
        public async Task ChangeSettings_WhenCalled_ShouldReturnResponseWitConflictStatusCode()
        {
            await E2ETester
        ...
        {
            return new ChangeBookcaseSettingsHttpRequest(_bookcaseGuid, _token)
                .AddPrivacyOption(
                    BookcaseOptionType.Privacy,
                    (PrivacyOption) ReflectionHelper.CreateInstance(typeof(PrivacyOption)));
        }
    }
}