...
{
    public class AddToBookcaseTest : EndToEndTest
    {
        ...
        [Test]
        public async Task AddToBookcase_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            IModule<ReadersModule> module = new ReadersModule();
            ...
            await E2ETester
                ...
                .Back()
                .AddTask(async () => await poller.Check(new AddToBookcaseReadersModuleProbe(module)))
                .DoAsync();
        }
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .Back()
                .SendSynchronously(CreateLibrarian())
                ...
                .Delay().Seconds(2)
                .SendAsync(new AddShelfHttpRequest(_bookcaseGuid, _token)
                    .WithShelfGuid(_shelfGuid));
        }
