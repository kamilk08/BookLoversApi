...
{
    public class GetPublicBookcaseTest : EndToEndTest
    {
        ...
        [Test]
        public async Task GetPublicBookcase_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            await E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(new GetBookcaseByIdHttpRequest(_bookcaseDto.Id, string.Empty))
            ...
            await E2ETester
                ...
                .SendAsync(() =>
                    new ChangeBookcaseSettingsHttpRequest(_bookcaseGuid, _token).AddPrivacyOption(
                        BookcaseOptionType.Privacy, PrivacyOption.Public))
                ...
                .SendSynchronouslyAndMapToResult(
                    new GetBookcaseByReaderIdHttpRequest(_readerDto.ReaderId, string.Empty))
