...
namespace BookLovers.Bookcases.Tests.EndToEndTests.RemoveFromBookcaseTests
{
    public class RemoveFromBookcaseAndUserIsNotAnOwnerOfTheBookcaseTest : EndToEndTest
    {
        ...
        [Test]
        public async Task
            RemoveFromBookcase_WhenCalledAndUserIsNotAnOwnerOfTheBookcase_ShouldReturnResponseWithForbiddenStatusCode()
        {
            await E2ETester
                .SendAsyncAndMapToResult(() => new RemoveFromBookcaseHttpRequest(_bookcaseGuid, _bookGuid, _token))
