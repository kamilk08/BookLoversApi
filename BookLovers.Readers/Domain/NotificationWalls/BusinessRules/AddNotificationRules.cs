...
{
    internal sealed class AddNotificationRules : BaseBusinessRule, IBusinessRule
    {
        protected override List<IBusinessRule> FollowingRules { get; } = new List<IBusinessRule>();

        public AddNotificationRules(
            ...
            Notification notification)
        {
            ...
            FollowingRules.Add(
                new NotificationWallCannotContainDuplicatedNotifications(notificationWall, notification));
        }
