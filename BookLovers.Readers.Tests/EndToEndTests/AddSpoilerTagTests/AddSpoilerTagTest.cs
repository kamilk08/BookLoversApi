...
{
    public class AddSpoilerTagTest : EndToEndTest
    {
        ...
        [Test]
        public async Task AddSpoilerTag_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            await E2ETester
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .AddRequestAsync(new CompleteRegistrationHttpRequest(
                    E2EConstants.SecondUserEmail,
                    _secondRegistrationToken))
                .SendPendingRequestsAsync()
