...
{
    public class AddFavouriteBookAndBookDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task AddFavouriteBook_WhenCalledAndBookDoesNotExit_ShouldReturnResponseWithConflictStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() =>
                    new AddFavouriteBookHttpRequest(Fixture.Create<Guid>(), _profileGuid, _token))
