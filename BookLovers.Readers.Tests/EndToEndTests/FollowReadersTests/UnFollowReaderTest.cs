...
{
    public class UnFollowReaderTest : EndToEndTest
    {
        ...
        [Test]
        public async Task UnFollowReader_WhenCalled_ShouldReturnResponseWithOkStatus()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new UnFollowReaderHttpRequest(_followedGuid, _token))
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .Back().SendAsync(
                    new FollowReaderHttpRequest(_followedGuid, _token));
        }
