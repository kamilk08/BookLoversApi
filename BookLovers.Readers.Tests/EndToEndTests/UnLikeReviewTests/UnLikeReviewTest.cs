...
{
    public class UnLikeReviewTest : EndToEndTest
    {
        ...
        [Test]
        public async Task UnLikeReview_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new UnLikeReviewHttpRequest(_reviewGuid, _token))
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .SendSynchronouslyAndMapToResult(() => new LikeReviewRequest(_reviewGuid, _token));
        }
