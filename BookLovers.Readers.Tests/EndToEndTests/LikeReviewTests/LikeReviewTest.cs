...
{
    public class LikeReviewTest : EndToEndTest
    {
        ...
        [Test]
        public async Task LikeReview_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            await E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new LikeReviewRequest(_reviewGuid, _token))
