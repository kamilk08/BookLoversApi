...
namespace BookLovers.Readers.Tests.EndToEndTests.LikeReviewTests
{
    public class LikeReviewAndReviewDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task LikeReview_WhenCalledAndReviewDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
            await E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new LikeReviewRequest(Fixture.Create<Guid>(), _token))
