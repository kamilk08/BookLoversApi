...
{
    public class AddFavouriteAuthorAndUserTriesToAddFavouriteAuthorNotToHisProfile : EndToEndTest
    {
        ...
        private Guid _secondProfileGuid;
        ...
        [Test]
        public async Task
            AddFavouriteAuthor_WhenCalledAndUserTriesToAddFavouriteAuthorNotToHisProfile_ShouldReturnResponseWithForbiddenStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new AddFavouriteAuthorRequest(_authorGuid, _secondProfileGuid, _token))
        ...
        {
            await E2ETester
                .Act(() => this._secondProfileGuid = Fixture.Create<Guid>())
                .Act(() => this._secondUserGuid = Fixture.Create<Guid>())
        ...
        {
            this.Logger = new LoggerConfiguration().MinimumLevel
                .Debug().WriteTo
                .Console(
        ...
        {
            return new RegisterUserHttpRequest()
                .WithUserGuid(this._secondUserGuid)
                .WithProfileGuid(this._secondProfileGuid)
