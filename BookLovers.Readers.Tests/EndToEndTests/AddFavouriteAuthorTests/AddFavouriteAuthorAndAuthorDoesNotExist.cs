...
{
    public class AddFavouriteAuthorAndAuthorDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task AddFavouriteAuthor_WhenCalled_ShouldReturnResponseWithConflictStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() =>
                    new AddFavouriteAuthorRequest(Fixture.Create<Guid>(), _profileGuid, _token))
