...
{
    public class EditProfileTestAndUserHasNoPermissionToDoIt : EndToEndTest
    {
        ...
        [Test]
        public async Task
            EditProfile_WhenCalledAndUserHasNoPermissionToDoIt_ShouldReturnResponseWithForbiddenStatusCode()
        {
            await E2ETester
