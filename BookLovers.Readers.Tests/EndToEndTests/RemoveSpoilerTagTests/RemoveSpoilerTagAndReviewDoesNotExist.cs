...
namespace BookLovers.Readers.Tests.EndToEndTests.RemoveSpoilerTagTests
{
    public class RemoveSpoilerTagAndReviewDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task RemoveSpoilerTag_WhenCalledAndReviewDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new RemoveSpoilerTagHttpRequest(Fixture.Create<Guid>(), _token))
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .Act(() => this._reviewGuid = Guid.NewGuid())
                ...
                .SendAsync(() => new AddSpoilerTagHttpRequest(_reviewGuid, _token));
        }
