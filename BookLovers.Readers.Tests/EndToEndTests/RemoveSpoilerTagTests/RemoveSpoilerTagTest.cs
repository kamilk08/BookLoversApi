...
{
    public class RemoveSpoilerTagTest : EndToEndTest
    {
        ...
        [Test]
        public async Task RemoveSpoilerTag_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new RemoveSpoilerTagHttpRequest(_reviewGuid, _token))
