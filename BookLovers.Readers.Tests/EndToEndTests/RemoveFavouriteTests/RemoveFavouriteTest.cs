...
namespace BookLovers.Readers.Tests.EndToEndTests.RemoveFavouriteTests
{
    public class RemoveFavouriteTest : EndToEndTest
    {
        ...
        [Test]
        public async Task RemoveFavourite_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .SendAsyncAndMapToResult(() => new RemoveFavouriteHttpRequest(_authorGuid, _profileGuid, _token))
                .Tap((result) => result.IsOk().Should().BeTrue())
                .Back()
                .AddTask(async () => await poller.Check(new RemoveFavouritePublicationModuleProbe(module)))
                .DoAsync();
        }
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .SendAsync(new AddFavouriteAuthorRequest(_authorGuid, _profileGuid, _token));
        }
