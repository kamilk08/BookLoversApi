...
{
    public class AddFavouriteBookTests : IntegrationTest<ReadersModule, AddFavouriteBookCommand>
    {
        ...
        [Test]
        public async Task AddFavouriteBook_WhenCalledAndCommandIsNotValid_ShouldReturnFailureResult()
        {
            this.Command = null;
        ...
        [Test]
        public async Task AddFavouriteBook_WhenCalledAndCommandHasInvalidData_ShouldReturnFailureResult()
        {
            this.Command = new AddFavouriteBookCommand(new AddFavouriteBookWriteModel
            {
        ...
        protected override async Task PrepareData()
        {
            ...
            await UnitOfWork.CommitAsync(new Favourite(_bookGuid, Fixture.Create<int>(), reader.Guid));
