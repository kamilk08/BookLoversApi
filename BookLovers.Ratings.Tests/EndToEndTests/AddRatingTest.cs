...
{
    public class AddRatingTest : EndToEndTest
    {
        ...
        [Test]
        public async Task AddRating_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful(flag => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() =>
                    new AddRatingHttpRequest(Star.Five, this._bookGuid, this._token))
