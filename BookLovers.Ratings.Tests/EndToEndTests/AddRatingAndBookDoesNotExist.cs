...
{
    public class AddRatingAndBookDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task AddRating_WhenCalledAndBookDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful(flag => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() =>
                    new AddRatingHttpRequest(Star.Five, this.Fixture.Create<Guid>(), this._token))
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await this.E2ETester
                ...
                .Back()
                .SendAsync(() =>
                    new CompleteRegistrationHttpRequest(E2EConstants.DefaultUserEmail, this._registrationToken))
                ...
                .SendSynchronouslyAndMapToResult(
                    new GetBookcaseByReaderIdHttpRequest(
