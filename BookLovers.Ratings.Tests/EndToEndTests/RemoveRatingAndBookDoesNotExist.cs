...
{
    public class RemoveRatingAndBookDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task RemoveRating_WhenCalledAndBookDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful(flag => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() =>
                    new RemoveRatingHttpRequest(this.Fixture.Create<Guid>(), this._token))
