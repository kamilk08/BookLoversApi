...
{
    public class ArchiveQuoteTestsWithEventStoreSnapshot :
        IntegrationTest<PublicationModule, ArchiveQuoteCommand>
    {
        ...
        public async Task ArchiveQuote_WhenCalled_ShouldReturnValidationResultWithoutErrorsAndArchiveQuote()
        {
            ...
            var queryResult = await this.Module.ExecuteQueryAsync<QuoteByGuidQuery, QuoteDto>(
        ...
        protected override async Task PrepareData()
        {
            ...
            var bookReader = new BookReader(Fixture.Create<Guid>(), _userGuid, _readerId);
            ...
            {
                await this.Module.SendCommandAsync(new LikeQuoteCommand(_quoteGuid));

                await this.Module.SendCommandAsync(new UnLikeQuoteCommand(_quoteGuid));
            });
