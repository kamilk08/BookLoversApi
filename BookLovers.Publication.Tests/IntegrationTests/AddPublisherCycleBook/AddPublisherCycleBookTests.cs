...
{
    public class AddPublisherCycleBookTests :
        IntegrationTest<PublicationModule, AddPublisherCycleBookCommand>
    {
        ...
        [Test]
        public async Task AddPublisherCycleBook_WhenCalledAndCommandIsNotValid_ShouldReturnFailureResult()
        {
            Command = null;
        ...
        [Test]
        public async Task AddPublisherCycleBook_WhenCalledAndCommandHasInvalidData_ShouldReturnFailureResult()
        {
            Command = new AddPublisherCycleBookCommand(Guid.Empty, Guid.Empty);
        ...
        [Test]
        public async Task AddPublisherCycleBook_WhenCalledAndCycleIsNotActive_ShouldThrowBusinessRuleNotMeetException()
        {
            var cycle = await UnitOfWork.GetAsync<PublisherCycle>(_publisherCycle.Guid);

            cycle.ApplyChange(new PublisherCycleArchived(cycle.Guid, cycle.PublisherGuid));
        ...
        [Test]
        public async Task
            AddPublisherCycleBook_WhenCalledAndCycleAlreadyHasSelectedBook_ShouldThrowBusinessRuleNotMeetException()
        {
