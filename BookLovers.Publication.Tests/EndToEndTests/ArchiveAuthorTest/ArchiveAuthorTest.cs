...
{
    public class ArchiveAuthorTest : EndToEndTest
    {
        ...
        [Test]
        public async Task ArchiveAuthor_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .Back()
                .AddTask(async () => await poller.Check(new ArchiveAuthorRatingsModuleProbe(ratingsModule)))
                .DoAsync();
        }
