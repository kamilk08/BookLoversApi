...
{
    public class CreateSeriesTest : EndToEndTest
    {
        ...
        [Test]
        public async Task CreateSeries_WhenCalled_ShouldReturnResponseWithCreatedStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .SendAsyncAndMapToResult(() => CreateSeries())
                .Tap((result) => result.IsCreated().Should().BeTrue())
                .Back()
                .AddTask(async () =>
                    await poller.Check(new CreateSeriesRatingsModuleProbe(ratingsModule, _seriesGuid)))
                .DoAsync();
        }
