...
{
    public class CreateBookTestAndAuthorDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task CreateBook_WhenCalledAndAuthorDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
        ...
        private CreateBookHttpRequest CreateBook()
        {
            return new CreateBookHttpRequest(_publisherGuid, _seriesGuid, _userGuid,
                new List<Guid> { Guid.NewGuid() }, _token).WithBookGuid(_bookGuid);
        }
