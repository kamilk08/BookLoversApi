...
{
    public class EditBookAndOneOfTheAuthorsDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task EditBook_WhenCalledAndOfTheAuthorsDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .SendAsyncAndMapToResult(() =>
                    new EditBookHttpRequest(_token).WithBook(data.BookWriteModel)
                        .WithCover(data.PictureWriteModel))
