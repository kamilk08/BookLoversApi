...
{
    public class EditBookTest : EndToEndTest
    {
        ...
        [Test]
        public async Task EditBook_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .Back()
                .AddTask(async () => await poller.Check(new EditBookRatingsModuleProbe(module)))
                .DoAsync();
        }
