...
{
    public class AddAuthorTestAndUserIsNotAuthorizedToDoIt : EndToEndTest
    {
        ...
        [Test]
        public async Task CreateAuthor_WhenCalled_ShouldReturnResponseWithUnAuthorizedStatusCode()
        {
