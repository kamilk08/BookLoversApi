...
{
    public class ArchiveBookTest : EndToEndTest
    {
        ...
        [Test]
        public async Task ArchiveBook_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .Back()
                .AddTask(async () => await poller.Check(new ArchiveBookInBookcaseModuleProbe(bookcaseModule)))
                .AddTask(async () => await poller.Check(new ArchiveBookInRatingsModuleProbe(ratingsModule)))
                .DoAsync();
        }
