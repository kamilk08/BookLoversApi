...
{
    public class UnFollowAuthorTest : EndToEndTest
    {
        ...
        [Test]
        public async Task UnFollowAuthor_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            await E2ETester
                .ArePrecedingRequestsSuccessful(flag => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(new UnFollowAuthorHttpRequest(_authorGuid, _token))
