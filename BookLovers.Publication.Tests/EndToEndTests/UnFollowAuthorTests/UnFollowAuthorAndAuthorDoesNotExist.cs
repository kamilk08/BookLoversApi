...
namespace BookLovers.Publication.Tests.EndToEndTests.UnFollowAuthorTests
{
    public class UnFollowAuthorAndAuthorDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task UnFollowAuthor_WhenCalledAndAuthorDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
            await E2ETester
                .ArePrecedingRequestsSuccessful(flag => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(new UnFollowAuthorHttpRequest(Fixture.Create<Guid>(), _token))
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .SendAsync(new FollowAuthorHttpRequest(_authorGuid, _token));
        }
