...
{
    public class EditAuthorTestWhenUserDoesNotHavePermissionToDoIt : EndToEndTest
    {
        ...
        [Test]
        public async Task
            EditAuthor_WhenCalledAndUserIsNotAllowedToEditAuthor_ShouldReturnResponseWithUnauthorizedStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new EditAuthorHttpRequest(CreateCommandData(), _token))
