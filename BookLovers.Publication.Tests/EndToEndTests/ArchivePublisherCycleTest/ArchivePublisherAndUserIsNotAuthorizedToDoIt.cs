...
{
    public class ArchivePublisherAndUserIsNotAuthorizedToDoIt : EndToEndTest
    {
        ...
        [Test]
        public async Task
            ArchivePublisherCycle_WhenCalledAndUserIsNotAuthorized_ShouldReturnResponseWithUnAuthorizedStatusCode()
        {
        ...
        private CreateBookHttpRequest CreateBook()
        {
            ...
            return new CreateBookHttpRequest(_publisherGuid, _seriesGuid,
                _userGuid, authors, _token).WithBookGuid(
                _bookGuid);
        }
