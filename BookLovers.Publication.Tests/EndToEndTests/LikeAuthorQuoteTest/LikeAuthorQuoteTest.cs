...
{
    public class LikeAuthorQuoteTest : EndToEndTest
    {
        ...
        [Test]
        public async Task LikeQuote_WhenCalled_ShouldReturnResponseOkStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new LikeAuthorQuoteHttpRequest(_quoteGuid, _token))
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .SendAsync(new RegisterUserHttpRequest()
