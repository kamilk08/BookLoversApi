...
{
    public class AddAuthorQuoteTest : EndToEndTest
    {
        ...
        [Test]
        public async Task CreateAuthorQuote_WhenCalled_ShouldReturnResponseWithCreateStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new CreateAuthorQuoteHttpRequest(_authorGuid, _token))
