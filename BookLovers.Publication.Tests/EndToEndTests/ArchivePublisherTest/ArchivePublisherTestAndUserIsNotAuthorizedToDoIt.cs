...
{
    public class ArchivePublisherTestAndUserIsNotAuthorizedToDoIt : EndToEndTest
    {
        ...
        [Test]
        public async Task
            ArchivePublisher_WhenCalledAndUserIsNotAuthorized_ShouldReturnResponseWithUnAuthorizedStatusCode()
        {
