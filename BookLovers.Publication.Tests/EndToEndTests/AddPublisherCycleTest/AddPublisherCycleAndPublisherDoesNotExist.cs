...
{
    public class AddPublisherCycleAndPublisherDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task
            CreatePublisherCycle_WhenCalledAndPublisherDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new CreatePublisherCycleHttpRequest(Fixture.Create<Guid>(), _token))
