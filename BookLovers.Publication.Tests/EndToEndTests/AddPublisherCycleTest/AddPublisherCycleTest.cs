...
namespace BookLovers.Publication.Tests.EndToEndTests.AddPublisherCycleTest
{
    public class AddPublisherCycleTest : EndToEndTest
    {
        ...
        [Test]
        public async Task CreatePublisherCycle_WhenCalled_ShouldReturnResponseWithCreatedStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .SendAsyncAndMapToResult(() => new CreatePublisherCycleHttpRequest(_publisherGuid, _token))
                .Tap((result) => result.IsCreated().Should().BeTrue())
                .Back()
                .AddTask(async () =>
                    await poller.Check(new AddPublisherCycleRatingsModuleProbe(ratingsModule)))
                .DoAsync();
        }
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await this.E2ETester
                ...
                .Act(() => this._publisherCycleGuid = Fixture.Create<Guid>())
                ...
                .Back()
                .SendAsync(() => new CreatePublisherHttpRequest(_token).WithPublisherGuid(_publisherGuid));
        }
