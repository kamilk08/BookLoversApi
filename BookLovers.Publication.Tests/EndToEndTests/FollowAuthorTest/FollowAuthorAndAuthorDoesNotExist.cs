...
{
    public class FollowAuthorAndAuthorDoesNotExist : EndToEndTest
    {
        ...
        [Test]
        public async Task FollowAuthor_WhenCalledAndAuthorDoesNotExist_ShouldReturnResponseWithConflictStatusCode()
        {
            await this.E2ETester
                .ArePrecedingRequestsSuccessful((flag) => flag.Should().BeTrue())
                .SendAsyncAndMapToResult(() => new FollowAuthorHttpRequest(Fixture.Create<Guid>(), _token))
