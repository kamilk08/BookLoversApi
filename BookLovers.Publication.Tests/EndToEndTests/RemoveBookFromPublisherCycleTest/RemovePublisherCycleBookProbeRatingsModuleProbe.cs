...
{
    public class RemovePublisherCycleBookProbeRatingsModuleProbe : IProbe
    {
        ...
        public RemovePublisherCycleBookProbeRatingsModuleProbe(IModule<RatingsModule> module)
        {
            _module = module;
        }
