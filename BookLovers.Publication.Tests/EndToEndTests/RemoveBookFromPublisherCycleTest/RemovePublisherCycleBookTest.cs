...
{
    public class RemovePublisherBookCycleTest : EndToEndTest
    {
        ...
        [Test]
        public async Task RemoveBookFromCycle_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            ...
            await E2ETester
                ...
                .SendAsyncAndMapToResult(() =>
                    new RemoveBookFromPublisherCycleHttpRequest(_bookGuid, _publisherCycleGuid,
                        _token))
                .Tap(result => result.IsOk().Should().BeTrue()).Back()
                .AddTaskAsync(async () =>
                    await poller.Check(new RemovePublisherCycleBookProbeRatingsModuleProbe(ratingsModule)))
                .DoAsync();
        }
        ...
        protected override async Task SendPreRequestsAsync()
        {
            await E2ETester
                ...
                .AddRequestAsync(CreateCycle)
                .AddRequestAsync(CreateBook)
                .SendPendingRequestsAsync()
                .SendAsync(new AddToPublisherCycleHttpRequest(_bookGuid, _publisherCycleGuid, _token));
        }
