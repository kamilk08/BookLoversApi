...
namespace BookLovers.Publication.Tests.EndToEndTests.ArchiveSeriesTest
{
    public class ArchiveSeriesTestAndUserIsNotAuthorizedToDoIt : EndToEndTest
    {
        ...
        [Test]
        public async Task ArchiveSeries_WhenCalled_ShouldReturnResponseWithUnAuthorizedStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .SendAsyncAndMapToResult(() => new ArchiveSeriesHttpRequest(_seriesGuid, _token))
                .Tap((result) => result.IsOk().Should().BeTrue())
                .Back()
                .AddTask(async () => await poller.Check(new ArchiveSeriesRatingsModuleProbe(ratingsModule)))
                .DoAsync();
        }
