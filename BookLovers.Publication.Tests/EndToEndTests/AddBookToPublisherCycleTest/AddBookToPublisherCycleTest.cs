...
{
    public class AddBookToPublisherCycleTest : EndToEndTest
    {
        ...
        [Test]
        public async Task AddBookToPublisherCycle_WhenCalled_ShouldReturnResponseWithOkStatusCode()
        {
            ...
            await this.E2ETester
                ...
                .SendAsyncAndMapToResult(() =>
                    new AddToPublisherCycleHttpRequest(_bookGuid, _publisherCycleGuid, _token))
                .Tap((result) => result.IsOk().Should().BeTrue())
                .Back()
                .AddTask(async () => await poller.Check(new AddBookToPublisherCycleRatingsModuleProbe(ratingsModule)))
                .DoAsync();
        }
